...
class SettingService
{
    ...
    public function getSMSModuleValidationData(object $request): array
    {
        ...
        $validation = [
            'gateway' => 'required|in:releans,twilio,priority_sms,nexmo,2factor,msg91,hubtel,paradox,signal_wire,019_sms,viatech,global_sms,akandit_sms,sms_to,alphanet_sms',
        ...
        } elseif ($request['gateway'] == 'priority_sms') {
            $additional_data = [
                'status' => 'required|in:1,0',
                'api_key' => 'required',
                'sender' => 'required',
