        ...
        if ($product) {
            ...
            $relatedProducts = $this->productRepo->getWebListWithScope(
                ...
                filters: [
                    ...
                    'sub_category_id' => isset($product['sub_category_id']) ? $product['sub_category_id'] : null,
                    'sub_sub_category_id' => isset($product['sub_sub_category_id']) ? $product['sub_sub_category_id'] : null,
                ],
                whereNotIn: ['id' => [$product['id']]],
            ...
            if(auth('customer')->user()){
                ...
                Helpers::wizgo_event_send(auth('customer')->user()->uuid, 'index',$event_value_arr);
                Helpers::wizgo_event_send(auth('customer')->user()->uuid, 'productview',[ route('product', $product['slug']) ]);
            }
            ...
            return view(VIEW_FILE_NAMES['products_details'], compact('product', 'countWishlist', 'countOrder', 'relatedProducts',
                ...
                'wishlistStatus', 'productReviews', 'rating', 'totalReviews', 'productsForReview', 'moreProductFromSeller', 'decimalPointSettings','latest_products'));
        }
