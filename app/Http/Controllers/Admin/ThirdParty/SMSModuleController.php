...
class SMSModuleController extends BaseController
{
    ...
    public function update(SMSModuleUpdateRequest $request, SettingService $settingService): RedirectResponse
    {
        ...
        if ($request['status'] == 1) {
            foreach (['releans', 'twilio', 'priority_sms' , 'nexmo', '2factor', 'msg91', 'hubtel', 'paradox', 'signal_wire', '019_sms', 'viatech', 'global_sms', 'akandit_sms', 'sms_to', 'alphanet_sms'] as $gateway) {
