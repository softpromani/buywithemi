...
class JusPayController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            ...
            } elseif (in_array(strtolower($data->payment_method_type), ['hdfc', 'icici', 'idfc_first', 'kotak_bank'])) {
                $juspay_data['payment_filter'] = [
                    'allowDefaultOptions' => true,
                    'options' => [],
                    'emiOptions' => [
            ...
            } elseif (strtolower($data->payment_method_type) === 'home_credit') {
                $juspay_data['payment_filter'] = [
                    'allowDefaultOptions' => false,
                    'emiOptions' => [
                        'standardEmi' => [
