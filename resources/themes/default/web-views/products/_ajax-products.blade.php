@if(count($products) > 0)
    ...
    @foreach($products as $product)
        ...
        @endif
        <div class=" {{Request::is('products*')?'col-lg-4 col-md-4 col-sm-4 col-12':'col-lg-2 col-md-3 col-sm-4 col-12'}} {{Request::is('shopView*')?'col-lg-3 col-md-4 col-sm-4 col-6':''}} p-2">
            @if(!empty($product))
    ...
    <div class="col-12 category-pagination-div" style="margin-top: 30px">
