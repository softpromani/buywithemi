<div class="__inline-9 rtl">
    ...
    <footer class="page-footer font-small mdb-color rtl">
        <div class="">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="footer-description col-12 footer-padding-bottom text-start">
                                    <h4 class="footer-brand-name footer-header ">FASTEMI</h4>
                    ...
                    <div class="row mt-4 pb-3 justify-content-between footer-link-list">
                        <div class="col-lg-6 px-0">
                            <div class="row mx-0 justify-content-between">
                                <div class="col-lg-6 col-6">
                                    <div class="">
                                        <h6 class=" mobile-fs-12  footer-header">Shop</h6>
                                        <ul class="widget-list __pb-10px">
                        ...
                        <div class="col-lg-6 px-0">
                            <div class="row mx-0 justify-content-between">
                                <div class="col-lg-6 col-6">
                                    <div class="">
                                        <h6 class=" mobile-fs-12  footer-header">Address</h6>
                                        <ul class="widget-list __pb-10px">

                                                <li class="widget-list-item">
                                                    <a class="widget-list-link">
                                                       Zebrs India OPC Private Limited, Near Aapni Yojana, Adarsh Market, Bhaleri Road, Churu-331001, Rajasthan, India. </br><a class="footer-phone-link" href="tel:+91 7849901616">+91 7849901616 </a></br><a class="footer-email-link" href="mailto:escalation@zebrs.com" style="text-transform: none;">escalation@zebrs.com</a>
                                                    </a>
                                                </li>
            ...
            <hr>
            <p class="text-center pt-3 mb-0 copyright-text" style="font-size: 14px">© 2024 Fastemi. All rights reserved.</p>
