    ...
    <div class="content container-fluid">
        ...
        <div class="row text-start">
            ...
            <div class="col-md-12 mt-2">
                <form class="product-form" action="{{route('admin.products.new-bulk-import')}}" method="POST"
                    ...
                    <div class="card rest-part">
                        <div class="px-3 py-4 d-flex flex-wrap align-items-center gap-10 justify-content-center">
                            ...
                            <a href="{{dynamicAsset(path: 'public/assets/bulk-product-import-format.xlsx')}}" download=""
