        ...
        <form class="product-form text-start" action="{{ route('admin.products.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="weight" name="weight" class="form-control"
                                    value="{{ old('weight') }}" placeholder="{{ translate('ex') . ': 2000' }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="origin" name="origin" class="form-control"
                                    value="{{ old('origin') }}" placeholder="{{ translate('ex') . ': India' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="hsn_sac_code" name="hsn_sac_code" class="form-control"
                                    value="{{ old('hsn sac code') }}" placeholder="{{ translate('ex') . ': ABC125' }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 physical_product_show" id="ean_code">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="{{ translate('ean_code') }}" name="ean_code"
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 physical_product_show" id="length">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="{{ translate('length') }}" name="length"
                                    class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 physical_product_show" id="width">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="{{ translate('width') }}" name="width"
                                    class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 physical_product_show" id="height">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="{{ translate('height') }}" name="height"
                                    class="form-control" required>
                            </div>
                        </div>
            ...
            <div class="card mt-3 rest-part physical_product_show">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-md-12">
                            <div class="input-button-container input-group mb-3" id="feat">
                        ...
                        <div class=" col-md-12 addDiv mt-3">
...
@push('script')
    ...
    <script>
        ...
        $('#addli').on('click', function(e) {
            e.preventDefault();
            var clonedElement = $('#feat').clone().removeAttr('id');
            clonedElement.find('input').attr('id', 'features-' + counter);
        ...
        $('.addDiv').on('click', '#remove', function(e) {
            e.preventDefault();
